...
export const Login = ({
  ...
  console.log("[Login] render", { loading, error });
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("[Login] handleSubmit", { email, password: password ? "••••" : "" });
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col items-center gap-6 lg:justify-start">
          ...
          >
            ...
            <Input name="email" type="email" placeholder="Email" className="text-sm bg-white" required />

            <label className="text-sm self-start">Mot de passe:</label>
            <Input name="password" type="password" placeholder="Mot de passe" className="text-sm bg-white" required />
